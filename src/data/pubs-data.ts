...
export const pubsData: Publication[] = [
  {
    ...
    description:
      "Proceeding of the VLDB Endowment (VLDB'26), <em>In press</em>",
    author: [
      "Qinghan Chen",
      `${MY_AUTHOR_MARKER}Muhammad Haekal Muhyidin Al-Araby`,
      "Ziyue Qiu",
      "Zhuofan Chen",
      "Rashmi Vinayak",
      "Juncheng Yang",
    ...
    artifact: "https://github.com/cacheMon/Lazy-Promotions/",
    featured: false, // true = appears as "PINNED" at the top
    link: "https://juncheng.seas.harvard.edu/publication/vldb26_lazyPromotion.pdf",
  },
];
